    ...
    <div style={{ backgroundColor: "#FAF8F5" }} className="min-h-screen">
      ...
      <section className="px-6 max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10 pb-20">
        ...
        <div className="lg:col-span-2">
          ...
          {/* Description */}
          <div className="mb-10">
            <h2 className="text-2xl font-light mb-4" style={{ color: "#0D1B2A", fontFamily: "var(--font-cormorant)" }}>About This Home</h2>
          ...
          {/* Features */}
          <div className="mb-10">
            <h2 className="text-2xl font-light mb-4" style={{ color: "#0D1B2A", fontFamily: "var(--font-cormorant)" }}>Property Features</h2>
          ...
          <div className="mb-10 p-6 border" style={{ borderColor: "#E8E4DF", backgroundColor: "#F5F0EB" }}>
            <h2 className="text-2xl font-light mb-2" style={{ color: "#0D1B2A", fontFamily: "var(--font-cormorant)" }}>Commute Calculator</h2>
