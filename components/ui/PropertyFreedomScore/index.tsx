...
import { computeScoreResult, Answers, ScoreResult, getScoreColor, CATEGORY_LABELS } from "./scoring";
  ...
  return (
    <div>
      ...
      <div style={{ height: "6px", backgroundColor: "#E8E3DC", borderRadius: "99px", overflow: "hidden" }}>
        <div style={{ height: "100%", width: `${score}%`, backgroundColor: "#8B2030", borderRadius: "99px", transition: "width 0.8s ease" }} />
      </div>
    </div>
  );
}
...
function RecommendationCard({ item }: { item: ScoreResult["quickWins"][0] }) {
  ...
  return (
    <div style={{ backgroundColor: "#FFFFFF", border: "1px solid #D8D2C8", borderRadius: "0.875rem", padding: "1.5rem", borderLeft: "3px solid #8B2030" }}>
      <h4 style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 700, fontSize: "1rem", color: "#1F2F3A", margin: "0 0 0.375rem" }}>{item.title}</h4>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
        <span style={{ fontFamily: "var(--font-dm-sans)", fontSize: "0.75rem", backgroundColor: "#F7F5F2", color: "#666666", borderRadius: "99px", padding: "0.2rem 0.6rem", border: "1px solid #D8D2C8" }}>{item.timeToImplement}</span>
        <span style={{ fontFamily: "var(--font-dm-sans)", fontSize: "0.75rem", backgroundColor: "#F7F5F2", color: diffColor, borderRadius: "99px", padding: "0.2rem 0.6rem", border: "1px solid #D8D2C8", fontWeight: 600 }}>{item.difficulty}</span>
        <span style={{ fontFamily: "var(--font-dm-sans)", fontSize: "0.75rem", backgroundColor: "#F7F5F2", color: impactColor, borderRadius: "99px", padding: "0.2rem 0.6rem", border: "1px solid #D8D2C8", fontWeight: 600 }}>{item.impact} Impact</span>
      </div>
    </div>
  );
}
...
export default function PropertyFreedomScore() {
  ...
  if (phase === "results" && result) {
    ...
    const subscoreEntries: [string, number][] = Object.entries(result.subscores).map(([k, v]) => [CATEGORY_LABELS[k] ?? k, v as number]);

    return (
      <div style={containerStyle}>
        {/* Score */}
        <div style={{ textAlign: "center", padding: "2rem 0", borderBottom: "1px solid #D8D2C8", marginBottom: "2rem" }}>
          <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.12em", fontWeight: 600, color: "#666666", marginBottom: "1rem" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: "0.875rem", color: "#666666", margin: "0 0 0.625rem" }}>/ 100 Property Freedom Score™</p>
        ...
        {/* Subscores */}
        <div style={{ marginBottom: "2rem" }}>
          <h3 style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 700, fontSize: "1.25rem", color: "#1F2F3A", marginBottom: "1rem" }}>Score Breakdown</h3>
        ...
        {/* Time cost */}
        <div style={{ backgroundColor: "#F7F5F2", border: "1px solid #D8D2C8", borderRadius: "0.875rem", padding: "1.25rem 1.5rem", marginBottom: "2rem" }}>
          <p style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 700, fontSize: "1rem", color: "#1F2F3A", margin: "0 0 0.375rem" }}>
            Your time cost
          </p>
          <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: "0.9375rem", color: "#555555", margin: 0 }}>
            You&apos;re spending roughly <strong style={{ color: "#1F2F3A" }}>{result.yearlyHours} hours per year</strong> — that&apos;s {workWeeks} work weeks — managing your rentals.
          </p>
        </div>

        {/* Quick wins */}
        <div style={{ marginBottom: "2rem" }}>
          <h3 style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 700, fontSize: "1.25rem", color: "#1F2F3A", marginBottom: "0.375rem" }}>Your Top 3 Quick Wins</h3>
          <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: "0.9375rem", color: "#666666", marginBottom: "1rem" }}>Based on your lowest-scoring areas.</p>
          <div style={{ display: "flex", flexDirection: "column", gap: "0.875rem" }}>
        ...
        {/* CTA */}
        <div style={{ backgroundColor: "#1F2F3A", borderRadius: "1rem", padding: "2rem", textAlign: "center", marginBottom: "1.5rem" }}>
          ...
          <a
            href="/contact"
            style={{ display: "inline-block", backgroundColor: "#8B2030", color: "#FAF8F5", fontFamily: "var(--font-dm-sans)", fontWeight: 600, fontSize: "0.9375rem", padding: "0.875rem 2rem", borderRadius: "0.5rem", textDecoration: "none" }}
          >
            Talk to Ebin →
          </a>
        ...
        <div style={{ textAlign: "center" }}>
          <button
            onClick={() => { setAnswers({}); setQIndex(0); setResult(null); setLeadName(""); setLeadEmail(""); setLeadPhone(""); transition(() => setPhase("welcome")); }}
            style={{ fontFamily: "var(--font-dm-sans)", fontSize: "0.875rem", color: "#999999", background: "none", border: "none", cursor: "pointer" }}
          >
            Retake assessment
          </button>
        </div>
