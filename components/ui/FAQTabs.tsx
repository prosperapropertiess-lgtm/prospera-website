...
const generalFaqs = [
  ...
  { q: "What makes you different from other property managers?", a: "At Prospera, Ebin manages relationships personally. We're transparent about fees, we don't markup maintenance, and we treat tenants with respect. That results in better long-term tenants for landlords." },
