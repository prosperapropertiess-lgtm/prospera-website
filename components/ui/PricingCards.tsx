...
function PlanCard({ plan, full = false }: { plan: typeof plans[0]; full?: boolean }) {
  return (
    ...
    >
      ...
      <div className="mb-8">
        <p className="text-xs uppercase tracking-widest mb-3" style={{ color: plan.key === "optimized" ? "#C5A55A" : "#5A7090", fontFamily: "var(--font-jakarta)" }}>
          {plan.label}
        </p>
