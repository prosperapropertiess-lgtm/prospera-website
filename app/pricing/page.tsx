          ...
          <div className="flex md:grid md:grid-cols-3 gap-6 mb-8 overflow-x-auto md:overflow-visible px-6 snap-x snap-mandatory [scrollbar-width:none] [&::-webkit-scrollbar]:hidden pb-2 md:pb-0">
              ...
              <div className="relative bg-[#112035] border border-[#1E3050] rounded-2xl p-8 flex flex-col h-full min-w-[80vw] md:min-w-0 snap-center">
                <div className="mb-8">
                  ...
                  <div className="flex items-end gap-2 mb-1">
                    <p className="text-6xl font-light text-[#FAF8F5]" style={{ fontFamily: "var(--font-cormorant)" }}>8%</p>
                    <p className="text-sm text-[#5A7090] mb-2" style={{ fontFamily: "var(--font-jakarta)" }}>/ month</p>
                  </div>
                  <p className="text-sm text-[#5A7090] mb-1" style={{ fontFamily: "var(--font-jakarta)" }}>
                    + 1 month&apos;s rent (placement)
                  </p>
                  <p className="text-base text-[#8899AA] mt-4 leading-relaxed" style={{ fontFamily: "var(--font-jakarta)" }}>
                ...
                <ul className="space-y-3 mb-8 flex-1" style={{ fontFamily: "var(--font-jakarta)" }}>
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-base text-[#8899AA]">
                ...
                <Link
                  href="/contact"
                  className="block text-center py-4 text-xs font-semibold uppercase tracking-widest border border-[#1E3050] text-[#FAF8F5] rounded-xl hover:border-[#FAF8F5] transition-colors"
            ...
            <FadeIn delay={0.1}>
              <div className="relative bg-[#060E1C] rounded-2xl p-8 flex flex-col h-full min-w-[80vw] md:min-w-0 snap-center">
                ...
                <Link
                  href="/contact"
                  className="block text-center py-4 text-xs font-semibold uppercase tracking-widest bg-[#C5A55A] text-[#FAF8F5] rounded-xl hover:opacity-90 transition-opacity"
                  style={{ fontFamily: "var(--font-jakarta)" }}
                >
                  Get Started
                </Link>
            ...
            <FadeIn delay={0.2}>
              <div className="relative bg-[#112035] border-2 border-[#C5A55A] rounded-2xl p-8 flex flex-col h-full min-w-[80vw] md:min-w-0 snap-center">
                ...
                <div className="mb-8">
                  <p className="text-xs uppercase tracking-widest text-[#5A7090] mb-3" style={{ fontFamily: "var(--font-jakarta)" }}>Passive</p>
                  <div className="flex items-end gap-2 mb-1">
                    <p className="text-6xl font-light text-[#FAF8F5]" style={{ fontFamily: "var(--font-cormorant)" }}>15%</p>
                    <p className="text-sm text-[#5A7090] mb-2" style={{ fontFamily: "var(--font-jakarta)" }}>/ month</p>
                  </div>
