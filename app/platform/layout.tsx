...
export const metadata: Metadata = {
  ...
  description:
    "Rent collected. N4s filed. Maintenance handled. You didn't lift a finger. The app Ontario landlords with 2–5 properties have been waiting for. 90 days free — no contracts.",
  openGraph: {
    title: "Prospera Platform — Landlording on Autopilot",
    description:
      "Rent collected automatically. N4s filed the moment rent is late. Maintenance triaged by AI. Built by an Ontario landlord, for Ontario landlords with 2–5 properties. 90 days free.",
    type: "website",
