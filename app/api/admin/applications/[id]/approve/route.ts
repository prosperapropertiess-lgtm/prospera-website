...
import { applicationApprovedTenantEmail } from "@/lib/emails";
...
export async function POST(
  ...
  if (resendKey) {
    ...
    resend.emails.send({
      ...
      html: applicationApprovedTenantEmail({
        tenantName: application.tenant_name,
        propertyAddress,
      }),
    }).catch((err: unknown) => console.error("[applications/approve] Tenant email failed:", err));
  }
