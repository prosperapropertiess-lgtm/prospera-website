        ...
        html: `
          <div style="font-family:sans-serif;max-width:580px;margin:0 auto;">
            <div style="background:#0D1B2A;padding:24px 32px;">
              <p style="color:#C5A55A;font-size:11px;letter-spacing:2px;text-transform:uppercase;margin:0 0 4px;">Prospera Social Agent</p>
            ...
            <div style="padding:32px;background:#FAF8F5;">
              ...
              <a href="${approveUrl}" style="display:inline-block;padding:14px 32px;background:#0D1B2A;color:#FAF8F5;text-decoration:none;font-size:11px;letter-spacing:2px;text-transform:uppercase;margin-right:12px;">Post it →</a>
