...
export const metadata: Metadata = {
  ...
  description:
    "Meet Ebin Jaison — owner of Prospera Properties. A hands-on property manager serving growing landlords with 4–15 doors across London, St. Thomas, and Strathroy, Ontario.",
};
