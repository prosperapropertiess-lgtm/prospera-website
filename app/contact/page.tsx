...
export default function ContactPage() {
  ...
  const inputClass = "w-full px-4 py-3 text-sm border border-gray-200 rounded bg-[#112035] text-[#FAF8F5] focus:outline-none focus:border-[#C5A55A] transition-colors";
      ...
      <section className="pb-24 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <FadeIn delay={0.1} className="md:col-span-2">
            {status === "success" ? (
              <div className="bg-[#0A1628] rounded-xl p-12 text-center border border-gray-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-5 bg-[#112035] rounded-xl p-8 shadow-sm border border-gray-100">
                {/* I am a... */}
