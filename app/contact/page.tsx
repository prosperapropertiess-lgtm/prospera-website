    ...
    <>
      ...
      <section className="pt-32 pb-20 px-6 bg-[#0A1628] text-center">
        <FadeIn>
          ...
          <p className="text-sm text-[#C0CAD4] max-w-md mx-auto leading-relaxed">
          ...
          <FadeIn>
            <div className="space-y-10">
              ...
              <div>
                ...
                <a href="mailto:hello@prosperaproperties.co" className="text-sm text-[#C0CAD4] hover:text-[#C5A55A] transition-colors break-all">
                  hello@prosperaproperties.co
                </a>
              </div>
              <div>
                <p className="text-xs uppercase tracking-widest text-[#C5A55A] mb-3">Service Areas</p>
                <p className="text-sm text-[#C0CAD4] leading-relaxed">London, Ontario<br />St. Thomas, Ontario<br />Strathroy, Ontario</p>
              </div>
              <div>
                <p className="text-xs uppercase tracking-widest text-[#C5A55A] mb-3">Portals</p>
                <div className="space-y-2">
                  <a href="https://prosperaproperties.buildiumapp.com" target="_blank" rel="noopener noreferrer" className="block text-sm text-[#C0CAD4] hover:text-[#C5A55A] transition-colors">Landlord Portal →</a>
                  <a href="https://prosperaproperties.buildiumapp.com" target="_blank" rel="noopener noreferrer" className="block text-sm text-[#C0CAD4] hover:text-[#C5A55A] transition-colors">Tenant Portal →</a>
                </div>
              </div>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.1} className="md:col-span-2">
            {status === "success" ? (
              <div className="bg-[#0A1628] rounded-xl p-12 text-center border border-[#C5A55A]/40">
                ...
                <p className="text-sm text-[#C0CAD4] mb-6">We&apos;ll be in touch within 1 business day.</p>
                <p className="text-xs text-[#9BAEC2]">In the meantime, feel free to call us at <a href="tel:+15196971227" className="text-[#C5A55A] hover:opacity-80">(519) 697-1227</a></p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5 bg-[#112035] rounded-xl p-8 shadow-sm border border-[#1E3050]">
                ...
                <div className="flex gap-4">
                  {["landlord", "tenant", "other"].map((t) => (
                    <button
                      ...
                      className={`flex-1 py-2.5 text-xs uppercase tracking-wide rounded border transition-colors ${form.type === t ? "bg-[#C5A55A] text-white border-[#C5A55A]" : "border-[#1E3050] text-[#C0CAD4] hover:border-[#C5A55A]"}`}
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="text-xs text-[#C0CAD4] mb-1.5 block">Full Name *</label>
                  ...
                  <div>
                    <label className="text-xs text-[#C0CAD4] mb-1.5 block">Email *</label>
                  ...
                  <div>
                    <label className="text-xs text-[#C0CAD4] mb-1.5 block">Phone</label>
                  ...
                  <div>
                    <label className="text-xs text-[#C0CAD4] mb-1.5 block">City</label>
                ...
                <div>
                  <label className="text-xs text-[#C0CAD4] mb-1.5 block">Message *</label>
