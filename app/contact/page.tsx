          ...
          <FadeIn delay={0.1} className="md:col-span-2">
            {status === "success" ? (
              <div className="bg-white rounded-xl p-12 text-center border" style={{ borderColor: "#D8D2C8", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
                <div className="w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-6" style={{ backgroundColor: "rgba(139,32,48,0.08)" }}>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 bg-white rounded-xl p-8 border" style={{ borderColor: "#D8D2C8", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
                ...
                {status === "error" && <p className="text-sm" style={{ color: "#8B2030", fontFamily: "var(--font-dm-sans)" }}>Something went wrong. Please try again or call us directly.</p>}
