...
import { TenantQuickCard } from "@/components/tenants/TenantQuickCard";
...
const NAVY = "#0F1C28";
const MUTED = "rgba(15,28,40,0.62)";
const SUBTLE = "rgba(15,28,40,0.45)";
    ...
    <>
      ...
      <div style={{ minHeight: "100vh", background: BG, position: "relative" }}>
        ...
        <main style={{ maxWidth: "860px", margin: "0 auto", padding: "48px 24px 120px", position: "relative", zIndex: 1 }}>
          ...
          >
            {quickCards.map((card) => (
              <TenantQuickCard key={card.label} card={card} />
            ))}
          </div>
