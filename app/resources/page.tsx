...
const RESOURCES: Resource[] = [
  {
    id: "ontario-standard-lease",
    title: "Ontario Standard Lease Agreement",
    description: "The official Ontario standard lease form, ready to fill in for any residential tenancy.",
    category: "forms",
    icon: "📄",
  },
  {
    id: "lease-addendum",
    title: "Lease Addendum Template (Prospera Edition)",
    description: "Our custom addendum that adds critical protections beyond the standard Ontario lease — covering utilities, maintenance, and tenant obligations.",
    category: "templates",
    icon: "📝",
  },
  {
    ...
    description: "Step-by-step checklist: credit check, income verification, reference calls, and what to look for at each stage.",
    category: "checklists",
    icon: "✅",
  },
  {
    id: "rent-increase-n1",
    title: "Rent Increase Notice Template (N1 Guide)",
    description: "Plain-English guide to Ontario's N1 form — how to fill it out correctly, serve it on time, and avoid common mistakes.",
    category: "templates",
    icon: "📈",
  },
  {
    id: "eviction-notices",
    title: "Eviction Notice Templates (N4, N5, N12)",
    description: "The three most commonly needed Ontario eviction forms, with plain-English explanations of when and how to use each one.",
    category: "forms",
    icon: "⚖️",
  },
  {
    ...
    description: "Move-in and move-out inspection form with photo documentation guide. Protects both landlord and tenant.",
    category: "checklists",
    icon: "🔍",
  },
  {
    id: "landlord-tax-guide",
    title: "Ontario Landlord Tax Deduction Guide",
    description: "What you can and cannot write off as a rental property owner in Ontario — mortgage interest, repairs, management fees, and more.",
    category: "guides",
    icon: "💼",
  },
  {
    ...
    description: "A simple form for tenants to submit maintenance requests in writing — creates a paper trail and keeps both sides accountable.",
    category: "forms",
    icon: "🔧",
  },
  {
    ...
    description: "Comprehensive tenant application form covering employment, income, rental history, references, and consent to credit check.",
    category: "forms",
    icon: "📋",
  },
  {
    id: "landlord-rights-guide",
    title: "Ontario Landlord Rights Quick Reference",
    description: "One-page summary of your key rights under the Residential Tenancies Act — entry, rent increases, evictions, and more.",
    category: "guides",
    icon: "🏠",
  },
];
        ...
        <div className="p-8">
          ...
          {status === "success" ? (
            <div className="text-center py-6">
              ...
              <h3 className="text-2xl font-light mb-3" style={{ color: "#0D1B2A", fontFamily: "var(--font-cormorant)" }}>
                Check your inbox.
              </h3>
              <p className="text-sm mb-6" style={{ color: "#5A5A5A", fontFamily: "var(--font-dm-sans)" }}>
                We've sent <strong>{resource.title}</strong> to {email}. Check your spam folder if it doesn't arrive within a minute.
              </p>
              <button
                onClick={onClose}
            ...
            <>
              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#7B1C1C", fontFamily: "var(--font-dm-sans)" }}>
                Free Download
              </p>
              <h3 className="text-2xl font-light mb-2 leading-snug" style={{ color: "#0D1B2A", fontFamily: "var(--font-cormorant)" }}>
                {resource.title}
              </h3>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                <input
                  ...
                  style={{ borderColor: "#E8E4DF", backgroundColor: "white", color: "#0D1B2A", fontFamily: "var(--font-dm-sans)" }}
                />
                <input
                  type="email"
                  value={email}
                ...
                <button
                  ...
                  className="py-3 text-xs uppercase tracking-widest mt-1 transition-opacity hover:opacity-80 disabled:opacity-50"
      ...
      <section className="px-6 py-6 border-b" style={{ borderColor: "#E8E4DF" }}>
        <div className="max-w-6xl mx-auto flex flex-wrap gap-3">
          {Object.entries(CATEGORY_LABELS).map(([key, label]) => (
            <span key={key} className="text-xs uppercase tracking-wider px-3 py-1.5 border" style={{ borderColor: "#0D1B2A", color: "#0D1B2A", fontFamily: "var(--font-dm-sans)" }}>
              {label}
            </span>
          ))}
        </div>
              ...
              <div className="bg-white border flex flex-col h-full" style={{ borderColor: "#E8E4DF" }}>
                <div className="p-6 flex-1">
                  <div className="flex items-start justify-between gap-3 mb-4">
                    ...
                    <span
                      className="text-xs uppercase tracking-wider px-2 py-1 shrink-0"
                      style={{ backgroundColor: "#F5F0EB", color: "#7B1C1C", fontFamily: "var(--font-dm-sans)" }}
                    >
                      {CATEGORY_LABELS[resource.category]}
                    </span>
                  </div>
                  <h3 className="text-lg font-medium mb-2 leading-snug" style={{ color: "#0D1B2A", fontFamily: "var(--font-cormorant)" }}>
                    {resource.title}
                  </h3>
