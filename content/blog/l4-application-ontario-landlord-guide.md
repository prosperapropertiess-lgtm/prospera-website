---
title: "L4 Application Ontario: Evicting a Tenant for Breaking a Settlement or Order"
date: "2026-07-23"
...
readTime: "9 min read"
featuredImage: "https://images.unsplash.com/photo-1589578235003-8e0e3a03ef41?w=1200&h=630&fit=crop&auto=format&q=80"
---
...
- The tenant is simply late on rent (no prior settlement or order). Use an [N4 notice and L1 application](/blog/n4-notice-ontario) instead.
- The tenant is causing noise, damage, or illegal activity for the first time. Use an [N5, N6, or N7 notice and L2 application](/blog/n5-notice-ontario) instead.
- The tenant gave notice to vacate or you agreed they can leave. Use an [L3 application](/blog/l3-application-ontario-landlord-guide) instead.
...
The [L4 form is available on the Tribunals Ontario website](https://tribunalsontario.ca/ltb/forms-filing-and-fees/). It's shorter than an L1 or L2 because you're not detailing grounds; you're citing an existing agreement or order.
...
**Online (fastest):** Visit the [Tribunals Ontario LTB Portal](https://tribunalsontario.ca/ltb/). Create an account if you haven't already, upload your completed L4 form, upload supporting documents (the settlement agreement, LTB order, photographs, notices), and pay the filing fee. You'll receive a confirmation email with your file number immediately.
...
- **$170** if filing online
- **$155** if filing in person
- Fees are waived or reduced if you meet low-income criteria; [check the LTB fee waiver policy](https://tribunalsontario.ca/ltb/forms-filing-and-fees/).
...
The hearing date will typically be 30–60 days after filing, depending on the LTB's schedule and local availability.
...
Even if you prove the breach, a hearing officer has discretion under [Section 83 of the RTA](https://www.ontario.ca/laws/statute/06r17/section83) to refuse the eviction order if they believe it would cause undue hardship to the tenant.
...
If the hearing officer issues an order to evict based on breach of settlement or prior order, the next steps are the same as any eviction order: the [Sheriff enforces it](/blog/enforcing-eviction-order-ontario-sheriff).
...
Prospera Properties manages rental properties in London, St. Thomas, and Strathroy, Ontario. If a tenant is breaking an agreement with you or violating an LTB order, we handle the documentation, filing, and hearing preparation. [Contact us](https://prosperaproperties.co/contact) to discuss your next steps.