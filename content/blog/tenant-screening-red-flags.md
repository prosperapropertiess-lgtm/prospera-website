...
**What to do:** Make it clear from the start that everyone living in the unit full-time must be on the application. Include occupancy limits and an unauthorized occupants clause in your lease.
...
1. [**Full credit check**](/blog/tenant-credit-check-ontario-landlords) (with written consent)
...
### Is it legal to ask a rental applicant about immigration status or citizenship in Ontario?
