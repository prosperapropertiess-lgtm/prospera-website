...
**You cannot cut off utilities or services.** Shutting off hydro, heat, or water to pressure a tenant into leaving violates RTA Section 21. The penalties are significant. Read more in our guide on [vital services cutoff and Ontario landlord liability](/blog/vital-services-cutoff-ontario-landlords).

**You cannot show up and demand they leave.** Your entry rights under the RTA are fixed — 24 hours' written notice for specific permitted reasons. Entry to pressure a tenant violates their right to [reasonable enjoyment](/blog/landlord-entry-rights-ontario).
...
An N11 must be a genuine, voluntary agreement. You cannot pressure a tenant into signing one. See our full guide on [the N11 agreement](/blog/n11-agreement-to-end-tenancy-ontario) for how this works in practice.
...
See our guide on [serving an N12 notice in Ontario](/blog/n12-notice-ontario) for the exact requirements.
...
An N8 requires the LTB to hold a hearing before any eviction order is issued. The board will review the evidence and may give the tenant a chance to correct the pattern. This is not a guaranteed outcome. See our [N8 notice guide](/blog/n8-notice-ontario) for the evidentiary requirements.
...
This is one of the more straightforward LTB paths, though it still takes time. See our [N4 notice guide](/blog/n4-notice-ontario) and our [L1 application guide](/blog/l1-application-ontario-landlord-guide).
...
For a deeper explanation of how lease expiry works and the RTA's automatic conversion rule, see our guide on [overholding tenants in Ontario](/blog/overholding-tenant-ontario).
...
For L1 (rent arrears) applications, the typical timeline from filing to order is 8–14 weeks. Sheriff enforcement (if the tenant does not leave voluntarily after an order) adds another 4–8 weeks. LTB timelines fluctuate. See [how long eviction takes in Ontario](/blog/how-long-does-eviction-take-ontario) for current estimates.

Document everything — communications, payment records, notice service — from the moment a dispute begins. See our [landlord record-keeping guide](/blog/landlord-record-keeping-ontario) for a practical filing system.
...
1. **Assuming the lease end date ends the tenancy.** It does not. Plan ahead if you want the unit back.
2. **Telling the tenant verbally to leave.** Written notice on the correct LTB form is required. A verbal request is not enforceable.
3. **Changing the locks or removing belongings.** This is an illegal lockout, full stop.
4. **Filing an N12 you do not intend to follow through on.** Fraudulent own-use evictions carry heavy penalties.
5. **Not documenting late payments.** If you want to file an N8, you need records. Reconstruct them now if you do not have them.
6. **Accepting partial payments after serving a notice.** Accepting partial rent after serving an N4 can void the notice. Get legal advice before accepting any payments during an active LTB process.
7. **Waiting and doing nothing.** The LTB process takes months. Start the correct legal process early — do not wait until you are frustrated enough to do something that makes the situation worse.
...
The purchaser can require the unit for their own residence. The process uses an N12 with 60 days' notice. The tenant is entitled to one month's compensation. The sale does not automatically end the tenancy. Read our [N12 guide](/blog/n12-notice-ontario) for the full requirements.
...
If you are managing this situation on your own and it is taking your attention away from your property and your other tenants, Prospera Properties helps small landlords in London, St. Thomas, and Strathroy manage exactly these situations — documentation, notices, LTB processes, and tenant communications — so you do not have to figure it out alone. [Learn more about how we work](/contact).
