---
title: "Ontario Rent Control Exemptions: Is Your Unit Exempt from the 2.1% Guideline?"
date: "2026-05-29"
...
readTime: "8 min read"
featuredImage: "https://images.unsplash.com/photo-1605146769289-52703bbe5b13?w=1200&h=630&fit=crop&auto=format&q=80"
---
...
You must serve the N1 at least **90 days before** the increase takes effect. Serving it late — even by one day — voids the increase, and you'd need to re-serve and wait another 90 days. The form must show the new rent amount and the date it takes effect.

See our [full guide to Ontario rent increase rules and the N1 form](/blog/rent-increase-ontario-guidelines) for step-by-step instructions.
...
If a new tenant is moving in and you're simply setting an initial rent, no N1 or N2 is required. The starting rent is whatever you and the tenant agree to in the [Ontario Standard Lease](/blog/ontario-standard-lease-2026). The N1/N2 only comes into play when raising rent for an existing tenancy.
...
1. **Check comparable listings.** Search Kijiji, Facebook Marketplace, and Rentals.ca for similar units in your neighbourhood. Look at size, finishes, utilities included, and proximity to transit or amenities.
2. **Factor in your costs.** Mortgage carrying costs, property taxes, insurance, maintenance reserves, and management fees should all be accounted for.
3. **Don't price aggressively at first.** Setting rent too high leads to vacancy. A good tenant at a fair rate is worth more than a marginally higher rent with weeks of vacancy.
4. **Document your rental rate.** Keep a record of why you set the rent where you did. If a dispute ever arises, documented reasoning supports your position.
...
[Get in touch with us today](/contact) to learn how we can support your rental portfolio, or visit our [landlord services page](/landlords) to see what full-service property management looks like.
