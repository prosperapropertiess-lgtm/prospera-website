...
See [landlord entry rights in Ontario](/blog/landlord-entry-rights-ontario) for more on what you can and cannot do with access to a rental unit.
...
If you want the tenancy to end at the end of a fixed term, you must serve an [N8 Notice to Terminate at End of the Term](/blog/n8-notice-ontario) **before** the lease end date. The N8 requires 60 days' notice, and the termination date must align with the last day of a rental period.
...
If you or a close family member intends to move into the unit, you can serve an [N12 Notice](/blog/n12-notice-ontario). This requires 60 days' notice plus compensation equal to one month's rent. The N12 can be served during a month-to-month tenancy — the original lease end date is irrelevant.
...
You and the tenant can sign an [N11 Agreement to End the Tenancy](/blog/n11-agreement-to-end-tenancy-ontario) to agree on a specific end date. This is the cleanest and fastest option if the tenant is willing. They leave on a date you both choose, you give them advance notice of what to expect, and there's no LTB application required.

For a full breakdown of the eviction process and timelines, see [how long does eviction take in Ontario](/blog/how-long-does-eviction-take-ontario).
...
See [lease renewal in Ontario: a landlord's guide](/blog/lease-renewal-ontario-landlord-guide) for the full process, including how to handle rent increases at renewal.
...
You can market the unit during the notice period, but you still need to comply with [landlord entry rights](/blog/landlord-entry-rights-ontario) — 24 hours' written notice for showings, reasonable times, the tenant's right to quiet enjoyment. The current tenant's legal rights don't diminish just because you're trying to find a replacement.
...
If the matter ultimately goes to the LTB, your paper trail is the difference between a clean hearing and a confusing one. See [landlord record-keeping in Ontario](/blog/landlord-record-keeping-ontario) for a practical system for tracking this across multiple properties.
...
If you're managing a London, St. Thomas, or Strathroy rental property and you're running into lease transitions, overholding situations, or uncertainty about the right next step, Prospera Properties handles this for small landlords across Southwestern Ontario. [Contact us](/contact) to talk through your situation.
