...
See our full guide on [fire safety obligations for Ontario landlords](/blog/fire-safety-ontario-landlords) for the complete inspection checklist.
...
Read more on [pest control responsibilities for Ontario rental properties](/blog/pest-control-ontario-rentals).
...
1. **No order issued** — the officer finds no violation. The matter is closed.
2. **Order to Comply issued** — the officer identifies violations and sets a deadline for correction.
3. **Emergency Order** — serious safety violations can result in an immediate order, sometimes requiring vacating the unit.
...
- Outstanding Orders block your rental unit licence renewal under the city's Rental Housing Licensing program — see our guide to the [rental unit licence renewal process](/blog/city-of-london-rental-unit-licence-renewal)
...
Good [landlord record-keeping](/blog/landlord-record-keeping-ontario) means you already have maintenance logs, inspection dates, and contractor invoices on file — exactly the documentation you'll need if you end up in front of the Property Standards Committee.
...
Your [landlord maintenance obligations under the RTA](/blog/landlord-maintenance-responsibilities-ontario) are a useful parallel read to understand how the two standards interact.
...
For a full breakdown of who needs a licence and how the program works, see our guide to the [City of London Rental Unit Licence](/blog/city-of-london-rental-unit-licence).
...
You have the right to enter with 24 hours' notice to make repairs under the RTA. If the tenant refuses access, document the attempt in writing and consult our guide on [landlord entry rights in Ontario](/blog/landlord-entry-rights-ontario). Do not let a tenant's refusal of access become an argument that you failed to maintain the property — the paper trail matters.
...
Most London landlords know the rules from the RTA. Fewer know there's a second set of rules from the city — and the city's enforcement runs on a completely separate track.
...
If managing municipal compliance across multiple London properties is consuming more time than it should, Prospera Properties handles property standards monitoring, maintenance coordination, and landlord compliance for small portfolios in London, St. Thomas, and Strathroy. [Contact us](/contact) to see how we can help.
