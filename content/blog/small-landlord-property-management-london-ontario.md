---
title: "Small Landlord Property Management: 7 Mistakes Costing London Landlords Thousands"
date: "2026-08-21"
...
Small landlords are doing all of this themselves, usually on top of a full-time job, and usually without ever having studied the [Residential Tenancies Act](https://www.ontario.ca/laws/statute/06r17) before they needed it.
...
- Preparing and executing the [Ontario Standard Lease](/blog/ontario-standard-lease-2026)
...
- Issuing proper rent increase notices within [Ontario's annual guideline limits](/blog/rent-increase-ontario-guidelines) — 90 days advance notice required
...
- Using correct LTB forms when issues arise ([N4 for non-payment](/blog/n4-notice-ontario), [N5 for interference](/blog/n5-notice-ontario), [N12 for landlord/purchaser intent](/blog/n12-notice-ontario), etc.)
- Meeting the 24-hour written notice requirement before entry
- Maintaining detailed records of all correspondence, payments, maintenance, and inspections
- Filing LTB applications correctly and preparing for hearings
...
A $40 credit check can save $15,000+ in lost rent and legal costs. [Recognizing tenant screening red flags](/blog/tenant-screening-red-flags) before signing — including employment inconsistencies, eviction history, or references that don't check out — is far cheaper than dealing with problem tenants after lease commencement.
...
An [N4 Notice to End a Tenancy Early for Non-Payment of Rent](/blog/n4-notice-ontario) has specific legal requirements: exact content, 14-day notice period, proper service method (personal delivery, email, or registered mail). A single error restarts the entire clock. Using an N4 with the wrong date or missing required language can be challenged by the tenant at the LTB, dismissing your application and extending the dispute by 2–4 months.

**Cost of mistake:** $2,000–$8,000 in extended rent loss per error.

### **3. Mishandling the Last Month's Rent Deposit**

Many small landlords treat the last month's rent deposit (LMR) as a damage fund. It isn't. Under the [Residential Tenancies Act](https://tribunalsontario.ca/ltb/), it can only be applied to the final month of rent. You are also required to pay annual interest on it (2.5% as of 2026).
...
[The rules around what landlords can and cannot deduct from last month's rent](/blog/what-can-landlord-deduct-from-last-month-rent-ontario) are worth reading in detail.

**Cost of mistake:** $1,500–$5,000 in repayment plus LTB fees.

### **4. Underdocumenting Everything**

Move-in condition reports without photos. Maintenance requests handled by phone with no written follow-up. Rent payments tracked in a notebook. When a dispute ends up at the [Landlord and Tenant Board](/blog/landlord-tenant-board-ontario-guide), documentation is everything.
...
### **6. Entering the Unit Without Proper Notice**
...
Entering without notice, or with verbal notice only, is a breach of the tenant's [right to quiet enjoyment](/blog/landlord-entry-rights-ontario) and can result in an N5 (Notice to End Tenancy for Interference) filed against you. The tenant can also file a T2 Application (Tenant Application for Reduction of Rent) for the breach.
...
Rent can only be increased once per 12-month period, and only by the Ontario guideline amount (2.5% for 2026). An increase requires an [N1 Form (Notice to End Tenancy for Landlord's Own Use)](/blog/n1-form-ontario-landlord-guide) or rent increase notice issued at least 90 days before the increase takes effect.
...
For detailed step-by-step guidance, see [how to increase rent in Ontario](/blog/how-to-increase-rent-ontario-step-by-step).
...
For a detailed breakdown of what these fees cover and how they compare across local providers, see [what property managers in London, Ontario typically cost](/blog/property-manager-london-ontario-cost).
...
When a tenancy ends, a well-run property manager also handles the full turnover: final inspection with photos, last month's rent deposit reconciliation with interest, unit prep, re-listing, and new tenant placement — [using a detailed tenant turnover checklist](/blog/tenant-turnover-checklist-ontario) to ensure nothing is missed.

For additional market benchmarking, the [CMHC's rental housing data for Ontario](https://www.cmhc-schl.gc.ca/professionals/housing-markets-data-and-research/housing-data/data-tables/rental-market/rental-market-report-data-tables) can help you verify that your unit's rent and your manager's performance are aligned with local conditions.
...
A: No. Leases can be for any duration (6 months, 1 year, 2 years, or even month-to-month). However, once the lease term ends, the tenancy converts to month-to-month unless both parties agree to a renewal. Use the [Ontario Standard Lease](/blog/ontario-standard-lease-2026) to avoid disputes over lease terms.
