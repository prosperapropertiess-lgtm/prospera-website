...
The RTA applies to most residential rental units in Ontario — houses, apartments, basement suites, condos rented out by their owners, and more. It covers:

- Rent increases and rent control
- Eviction procedures
- Maintenance standards
- Tenant rights during inspections
- Rules around lease agreements

**What it does NOT cover:** Retirement homes, most social housing, commercial properties, and owner-occupied units where the tenant shares a kitchen or bathroom with the landlord.
...
## Common Eviction Forms and When to Use Them

| Form | Purpose | Notice Period |
|------|---------|---------------|
| N4 | Non-payment of rent | 14 days |
| N5 | Interfering with enjoyment / damage | 20 days (first notice) |
...
### The N12: Personal Use

This is one of the most misused forms. You can only serve an N12 if you, your spouse, a parent, or your child genuinely intends to move in. The LTB takes bad-faith N12s seriously — tenants have successfully claimed compensation when they believe a landlord filed one just to remove them.

Requirements:
- 60 days' notice
- Notice must end on the last day of a rental period
- You must compensate the tenant with one month's free rent OR provide them with a comparable unit

## Maintenance and Repairs

Under the RTA, landlords must keep rental units in **good repair** and comply with health, safety, and housing standards — even if the tenant knew about problems before signing the lease.

Tenants can file a T6 (maintenance complaint) with the LTB. If the LTB sides with them, you could face rent abatements, repair orders, or fines.

**Protect yourself:** Document all repair requests in writing. Use a work order system (even a simple email thread) and respond to urgent repairs within 24 hours.

## Entry Rules

You cannot enter a tenant's unit without proper notice — even if you own the building. Generally you need **24 hours' written notice** for:
...
If you're managing on your own and feeling uncertain about any of this, [get in touch](/contact) — we're happy to give you a no-pressure walkthrough of your situation.
