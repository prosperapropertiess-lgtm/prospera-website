---
title: "L9 Application Ontario: Collect Rent Arrears Without Evicting Your Tenant"
date: "2026-05-25"
slug: "l9-application-ontario"
...
newsletterHook: "The L9 application lets Ontario landlords collect unpaid rent through an LTB order without ending the tenancy — ideal when you have a good tenant who hit a rough patch. Almost Passive is where I cover exactly this stuff — free, once a week."
...
For more on the L1 process, see our [complete L1 application guide](/blog/l1-application-ltb-ontario).
...
For a full breakdown of the N4 form, see our [N4 notice guide](/blog/n4-notice-ontario).
...
If the arrears are clear and the N4 was served correctly, you should receive an order the same day or within a few days of the hearing.
...
For advice on when to switch from L9 to L1 strategy, our [late rent payments guide](/blog/late-rent-payments-ontario) covers the full escalation ladder.
...
- **You've already agreed on a repayment plan and they've broken it.** Consider whether you need the LTB at all — sometimes a written repayment agreement (without an LTB order) is enough, and you can file a new N4/L1 if they breach it. Our [rent repayment agreement guide](/blog/rent-repayment-agreement-ontario) explains how those work.
...
If you're a self-managing landlord dealing with an arrears situation right now, the steps above will guide you through it. If you'd rather have someone handle the process — forms, filings, hearings, and enforcement — [reach out to us](/contact).
...
For hands-on help navigating arrears, hearings, and everything else that comes with owning rental property, [contact Prospera Properties](/contact) — we're here to make this easier.
