---
title: "N8 Notice Ontario: How to End a Tenancy for Persistent Late Rent Payment"
date: "2026-05-08"
slug: "n8-notice-ontario"
excerpt: "The N8 notice lets Ontario landlords end a tenancy when a tenant repeatedly pays rent late — even if the rent eventually gets paid. Here's when to use it, what evidence you need, and how to file an L2 application."
...
The N4 is a short-fuse notice — it's immediate and reactive. The N8 is a longer-game tool that targets behavior, not just balance. For more on using the N4 effectively, see our [complete N4 notice guide](/blog/n4-notice-ontario).
...
For a full walkthrough of the eviction process from notice to order, see our [step-by-step eviction guide](/blog/evicting-tenant-ontario).
...
- **Property management support:** If you're a landlord in London, St. Thomas, or Strathroy and the N8 process feels overwhelming, Prospera Properties can help document the pattern, serve notices correctly, and navigate the LTB from start to finish. [Visit our landlord services page](/landlords) or [contact us directly](/contact).

For a broader overview of how the LTB works and what to expect at a hearing, our [Ontario LTB guide](/blog/landlord-tenant-board-ontario-guide) covers the process in detail.
