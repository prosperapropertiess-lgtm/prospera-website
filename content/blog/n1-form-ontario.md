---
title: "N1 Form Ontario: Step-by-Step Guide to Serving a Rent Increase Notice"
date: "2026-06-01"
slug: "n1-form-ontario"
...
newsletterHook: "Learn how to correctly complete and serve the N1 Notice of Rent Increase in Ontario — including how to calculate the 2026 guideline amount, the 90-day notice rule, valid service methods, and what voids the increase. That's the kind of local, practical detail that goes in Almost Passive every week."
...
The N1 form is available for free on the [Tribunals Ontario website](https://tribunalsontario.ca/ltb/forms/).
...
For a deeper look at which units are exempt and how the guideline is set each year, see our [guide to Ontario rent increase guidelines](/blog/rent-increase-ontario-guidelines).
...
**1. Has it been at least 12 months since the last rent increase (or since the tenant moved in)?**
Ontario's Residential Tenancies Act (RTA) limits rent increases to once every 12 months. The 12-month clock starts from either the date the tenant first moved in or the date of the last rent increase — whichever is more recent. You cannot raise rent more frequently than once per year, even if each increase is below the guideline.

**2. Is the unit covered by rent control?**
If your unit was first occupied before November 15, 2018, you're limited to the 2.1% guideline. If it was first occupied on or after that date, you can raise rent to any amount — but you still need to serve a properly completed N1.
...
To understand what happens when a tenant doesn't pay after a valid increase, read our [complete guide to the N4 Notice of Non-Payment](/blog/n4-notice-ontario).
...
For guidance on the renewal conversation, see our [Ontario lease renewal guide for landlords](/blog/lease-renewal-ontario-landlord-guide).
...
At **Prospera Properties**, we manage rent increases for landlords across London, St. Thomas, and Strathroy, Ontario — ensuring every N1 is correctly calculated, served on time, and documented. If you'd rather not track this yourself, [contact us](/contact) to find out how we handle the full rent cycle on your behalf.
...
For more on managing your rental property effectively in Ontario, visit our [landlords page](/landlords) or [reach out to our team](/contact).
