---
title: "L2 Application Ontario: Complete Landlord Guide to LTB Eviction for Behaviour & Damage"
date: "2026-07-21"
slug: "l2-application-ontario-landlord-guide"
excerpt: "Step-by-step guide to filing an L2 application with the Ontario LTB. Learn when to use L2, how to prepare your case, and what to expect at a hearing."
...
- **Tenant behaviour** (excessive noise, harassment, violence, threats) — filed after serving an [N5 notice](/blog/n5-notice-ontario)
- **Willful or negligent damage** to the unit — filed after serving an [N7 notice](/blog/n7-notice-ontario)
- **Illegal activity** (drug production, theft, prostitution) — filed after serving an [N6 notice](/blog/n6-notice-ontario)
...
Unlike an [L1 application](/blog/l1-application-ontario-landlord-guide) (which combines eviction and money), an L2 is eviction only. You cannot recover unpaid utilities, damage costs, or other money through an L2. If you need money, you file a separate [Small Claims Court](https://www.ontario.ca/page/small-claims-court) action after the tenancy ends.
...
|--------|-------------|-------------|-----------|
| Excessive noise, harassment, interference | [N5](/blog/n5-notice-ontario) | 7 days | Yes |
| Willful/negligent damage to the unit | [N7](/blog/n7-notice-ontario) | None (N7 is immediate) | Yes |
| Illegal act/trade in the unit | [N6](/blog/n6-notice-ontario) | 10 or 20 days (varies) | Yes |
| Non-payment of utilities (tenant liable) | N4 | 14 days | Yes |
| Tenant lied on application (subsidized housing) | N6 | 60 days | Yes |
| Non-payment of rent | [N4](/blog/n4-notice-ontario) | 14 days | No (use L1 instead) |
| Landlord's own use / demolition | [N12](/blog/n12-notice-ontario) | 60 days | No (use L2, but different grounds) |
...
[Valid service methods](/blog/landlord-record-keeping-ontario) under the RTA are:
...
[Tribunals Ontario operates a single online portal](https://tribunalsontario.ca/ltb/) for all LTB applications. You can file:
...
[The full L2 instructions and form are available on the Tribunals Ontario website](https://tribunalsontario.ca/documents/ltb/Landlord%20Applications%20&%20Instructions/L2_Instructions.pdf).
...
If you cannot afford the fee, you can request a fee waiver by filing a [Fee Waiver Request form](https://tribunalsontario.ca/ltb/).
...
This is critical. Even if you prove the ground for eviction, the LTB can refuse or postpone your eviction under [RTA Section 83](/blog/rta-section-83-ontario). The adjudicator will consider:
...
**Mistake 1: Filing L2 without serving notice first.**
You must serve the correct notice form (N5, N6, N7, etc.) before filing L2. The void period (or lack thereof) is part of the RTA process. Skipping notice invalidates your L2.

**Mistake 2: Weak or missing documentation.**
The LTB operates on evidence. If you did not keep a diary, take photos, or get witness statements, you have a weak case. The tenant's word against yours loses.

**Mistake 3: Serving notice incorrectly.**
If you mail the notice but do not prove it was received, or if you serve it in a way the RTA does not allow, it is invalid. Service must be proven at the hearing.

**Mistake 4: Waiting too long to file L2.**
You have 30 days after the void period to file. If you miss this window, the LTB will reject your application (or you lose the ground). Do not delay.

**Mistake 5: Being vague about the breach.**
"Tenant is loud" loses. "Tenant played loud music at 2 AM on July 10, 15, and 18; police attended twice; neighbours in Units 204 and 206 complained in writing" wins.

**Mistake 6: Underestimating Section 83.**
Even strong cases fail if the tenant is vulnerable and the breach is minor. Prepare a counter-narrative: why you cannot live with this behaviour, and why postponement is not fair to you.

**Mistake 7: Not bringing a witness.**
If you have a neighbour or building staff who witnessed the breach, bring them. Testimony from a neutral party is powerful.
...
Prospera Properties manages rentals across London, St. Thomas, and Strathroy — including full LTB case preparation and representation. If you are facing a tenant breach and need guidance on whether to file an L2, [contact us](/contact) for a consultation.